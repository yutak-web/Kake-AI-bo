...
const AggregationPage: React.FC = () => {
  ...
  // Clear category filter when switching incompatible views
  useEffect(() => {
    if (view === 'expense') {
  ...
  // Filtered transactions based on view, date range, and category
  ...
  const renderFilter = () => {
    // Determine which categories to show based on current view
